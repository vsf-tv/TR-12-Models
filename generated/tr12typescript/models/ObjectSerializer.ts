...
let typeMap: {[index: string]: any} = {
    ...
    "AuthenticatePairingCodeResponseContent": AuthenticatePairingCodeResponseContent,
    "CreatePairingCodeFailureData": CreatePairingCodeFailureData,
    "CreatePairingCodeRequestContent": CreatePairingCodeRequestContent,
    "CreatePairingCodeResponseContent": CreatePairingCodeResponseContent,
    "CreatePairingCodeResult": CreatePairingCodeResultClass,
    "CreatePairingCodeSuccessData": CreatePairingCodeSuccessData,
    "DeprovisionDeviceRequestContent": DeprovisionDeviceRequestContent,
    "Failure": Failure,
    "GetHostConfigResponseContent": GetHostConfigResponseContent,
    "GetVersionResponseContent": GetVersionResponseContent,
