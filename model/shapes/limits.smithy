...
///   5 templates × (50 settings×265B + 25 profiles×105B + 25 protocols×20B)
///   + 50 assignments × 50B
...
/// MAX_ENUM_VALUES            = 25   (choices per enum setting)
/// MAX_PROFILES_PER_TEMPLATE  = 25   (profiles per channel template)
/// MAX_PROTOCOLS_PER_TEMPLATE = 25   (transport protocols per channel template)
